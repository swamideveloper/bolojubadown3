...
public class VideoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static boolean isSwitchView = false;
    Activity activity;
    int my_vla;
    ...
    public VideoListAdapter(Context context, List<PlayerVideoModel> modelList, int my_vla, boolean listgrid, List<PlayerVideoModel> modelList_onlypass) {
        ...
        videoUtils = new VideoUtils(context);
...
//                            intent.putExtra("list",(Serializable) modelList);
//                            intent.putExtra("position", position);
            ...
            holder.ivMore.setOnClickListener(new SingleClickListener() {
                @Override
    ...
    public static boolean toggleItemViewType() {
    ...
    private void videoDetails(Context context, PlayerVideoModel model, int i) {
        ...
        if (my_vla == 4) {
            ...
            add_playlist.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    videoUtils.addToPlaylist(model);
                    notifyDataSetChanged();
                    sheetDialog.dismiss();
                }
            });
        ...
        llDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("data", "onClick: " + model.getData());
                Log.e("pathhh", "onClick: " + file.getAbsolutePath());
    ...
    public void remove(int i) {
        ...
        Toast.makeText(context, "file_successfully_deleted", Toast.LENGTH_SHORT).show();
    }

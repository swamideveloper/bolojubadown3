...
public class Videolist {
    ...
    public Videolist(Context ctx) {
        this.context = ctx;
        myDBHelper = new ReaderDB(context);
    }

    public Videolist open() {
        db = myDBHelper.getWritableDatabase();
        Log.e("DATA","open==="+db);
        return this;
    }

    public Videolist close() {
        myDBHelper.close();
        Log.e("DATA","close===");
        return this;
    }
    ...
    public boolean searchVideolist(String name) {
    ...
    public class ReaderDB extends SQLiteOpenHelper {
        ...
        public ReaderDB(Context context) {
            ...
            Log.e("DATA","DATABASE_NAME==="+DATABASE_NAME);
        }

        public void onCreate(SQLiteDatabase db) {
            db.execSQL(SQL_CREATE_ENTRIES);

            Log.e("DATA","oncreate==="+db);
        }

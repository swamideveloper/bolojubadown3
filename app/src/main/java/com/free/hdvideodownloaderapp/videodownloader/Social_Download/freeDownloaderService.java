...
public class freeDownloaderService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (extras == null) {
            ...
            FinalOutputFileName = free_UCommons.SanitizeTitle((String) extras.get("FinalOutputFileName")) + "_" + System.currentTimeMillis() + ".mp4";
        }
    ...
    private Notification getMyActivityNotification(String text) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this,
                0, new Intent(this, freeMainActivity.class), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        return new NotificationCompat.Builder(this, "Alertify")
                .setContentTitle(title)
                .setDefaults(Notification.DEFAULT_ALL)
                .setContentText(text)
                .setSound(null)
                .addAction(R.drawable.logo, mContext.getString(R.string.Dismiss), makePendingIntent("quit_action"))
                .setSmallIcon(R.drawable.logo)
                .setContentIntent(contentIntent).build();
    }

    public PendingIntent makePendingIntent(String name) {
        Intent intent = new Intent(this, freeNotificationReciver.class);
    ...
    private void download_Video() {
        new freeDownloader(VideoURL, mContext, downloadPath) {
            @Override
    ...
    private void download_audio() {
        new freeDownloader(AudioURL, mContext, downloadPath) {
            @Override
            public void onDownloaderError(String ErrorMessage) {

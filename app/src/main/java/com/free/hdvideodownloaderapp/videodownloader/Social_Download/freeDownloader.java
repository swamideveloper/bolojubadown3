...
public abstract class freeDownloader extends Thread {
    ...
    public freeDownloader(String _M3U8_URL, Context _context, String _baseDownloadDir)
    {
        M3U8_URL=_M3U8_URL;
        context=_context;
    ...
    private OnM3U8DownloadListener onM3U8DownloadListener = new OnM3U8DownloadListener() {
        ...
        public void onDownloadProgress(final M3U8Task task) {
            ...
            if(free_UCommons.isMyServiceRunning(freeDownloaderService.class,context))
            {

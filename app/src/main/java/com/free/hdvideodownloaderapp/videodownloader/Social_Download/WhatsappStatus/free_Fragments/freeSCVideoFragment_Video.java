...
public class freeSCVideoFragment_Video extends Fragment {
            ...
            if (allFiles != null && allFiles.length != 0) {
                for (int i = 0; i < allFiles.length; i++) {
                    if (!allFiles[i].getUri().toString().contains(".nomedia")) {
                        if (allFiles[i].getUri().toString().contains(".gif")
                                || allFiles[i].getUri().toString().contains(".mp4"))
                ...
                if (d1 != null && !d1.isEmpty()) {
                    ...
                    c1 = new freeVideoSCImageAdapter(this.d1, this.a1, 2);
                    f1.setAdapter(c1);
                }

...
public class freeAlbumGridAdapter extends BaseAdapter {
    ...
    public freeAlbumGridAdapter(Context context, ArrayList<HashMap<String, String>> mobileValues) {
...
//                    outline.setRoundRect(0, 0, view.getWidth(), Math.round(view.getHeight()), 10F);
//                }
//            });
//            holder.image.setClipToOutline(true);
//            (new ImageUtils(context)).setAlbumArt(albumSongs, holder.image);

            (new ImageUtils(context)).smallsetAlbumArt(albumSongs, holder.image);


//            if (position % 4 == 0) {
//                holder.liner.setBackground(context.getResources().getDrawable(R.drawable.color_back1));
////                holder.image.setImageDrawable(context.getResources().getDrawable(R.drawable.color_folder1));
//            } else if (position % 4 == 1) {
//                holder.liner.setBackground(context.getResources().getDrawable(R.drawable.color_back2));
////                holder.image.setImageDrawable(context.getResources().getDrawable(R.drawable.color_folder2));
//            } else if (position % 4 == 2) {
//                holder.liner.setBackground(context.getResources().getDrawable(R.drawable.color_back3));
////                holder.image.setImageDrawable(context.getResources().getDrawable(R.drawable.color_folder3));
//            } else if (position % 4 == 3) {
//                holder.liner.setBackground(context.getResources().getDrawable(R.drawable.color_back4));
////                holder.image.setImageDrawable(context.getResources().getDrawable(R.drawable.color_folder4));
//            }

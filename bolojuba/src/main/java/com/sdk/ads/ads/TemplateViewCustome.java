...
public class TemplateViewCustome extends FrameLayout {
...
//    private LinearLayout background;
    ...
    public TemplateViewCustome(Context context) {
        super(context);
    }

    public TemplateViewCustome(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public TemplateViewCustome(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @SuppressLint("NewApi")
    public TemplateViewCustome(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
